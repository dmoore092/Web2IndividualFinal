...
<?php include "../assets/inc/head.php" ?>
        ...
        <img class="medium" src="<?php echo $imgpath ?>OurBeachSunset800.jpg"
             alt="rincon sunset"/>
            <img class="big" id="large" src="<?php echo $imgpath ?>OurBeachSunset1300.jpg"
             alt="rincon sunset"/>
        ...
        <div class="body-copy-flex">
                <div class="indextext">
                    ...
                    <p>
                        ...
                        see the beach in the early morning.
                    </p>
                    <p> 
                        This beach was fantastic, and was less than a 30 second walk
